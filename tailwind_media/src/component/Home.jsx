      ...
      <div className="flex justify-center">
        ...
        <nav className=" py-3 w-max bg-white text-black  mt-5 rounded-3xl px-5 flex justify-between ">
          ...
          <div className=" md:flex space-x-4">
            ...
            <div className="md:hidden text-3xl md:p-2 py-1 px-1 mt-2 bg-gradient-to-r from-blue-400 to-purple-500 rounded-xl   text-gray-800 cursor-pointer md:pt-2 pt-1">
